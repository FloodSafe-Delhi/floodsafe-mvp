        ...
        {catalogError && (
          <div className="px-6 pb-6">
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <p className="text-sm text-red-600">Failed to load badges. Please try again.</p>
            </div>
          </div>
        )}
            ...
            <div className="space-y-6">
              {selectedCategory === 'all' ? (
                ...
                Object.entries(groupedBadges).map(([category, badges]) => (
                  badges.length > 0 && (
                    <div key={category}>
                      <h3 className="text-sm font-semibold text-gray-700 mb-3 capitalize flex items-center gap-2">
                        {category}
                        <BadgeUI variant="secondary" className="text-xs bg-gray-100 text-gray-600">
              ...
              {filteredBadges.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-600 font-medium">No badges found</p>
