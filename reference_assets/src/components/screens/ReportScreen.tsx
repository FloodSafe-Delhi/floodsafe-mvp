          ...
          <Card className="p-4">
            ...
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600">Janpath, New Delhi</p>
              ...
              <div>
                ...
                <Input 
                  id="landmark" 
                  placeholder="e.g., Metro Station, Mall" 
                  className="mt-1"
                />
              </div>
            </div>
          ...
          <Card className="p-4">
            ...
            <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-800">
                💡 Tip: Clear photos of water level markers or landmarks increase report accuracy by 40%
              </p>
            </div>
          </Card>
        )}
        ...
        {step === 4 && (
          <div className="space-y-4">
            ...
            <Card className="p-4">
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="otp">Enter OTP sent to +91-XXXX-XXX-456</Label>
                  <Input 
                    id="otp" 
                    placeholder="000000" 
                    maxLength={6}
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  <p className="text-xs text-gray-600">
                    🔒 Privacy: Location anonymized to 100m radius. Your phone number will not be shared publicly.
                  </p>
                </div>
              </div>
            </Card>
      ...
      <div className="fixed bottom-16 left-0 right-0 bg-white border-t p-4 space-y-2 safe-area-bottom">
        {step < totalSteps ? (
          ...
          <Button 
            className="w-full" 
            onClick={handleNext}
            disabled={!confirmed || otp.length !== 6}
          >
            Submit Report
          </Button>
        )}
